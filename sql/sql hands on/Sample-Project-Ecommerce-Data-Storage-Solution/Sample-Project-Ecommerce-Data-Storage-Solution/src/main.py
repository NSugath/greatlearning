...
if __name__ == "__main__":
    ...
    q5 = """
    SELECT  o.customer_id, MAX(o.total_value) as MAX_Value, o.order_id, c.customer_name, c.customer_email
    FROM ecommerce_record.orders o 
    LEFT JOIN ecommerce_record.customers c ON o.customer_id = c.customer_id 
    ...
    sql = '''
    INSERT INTO customer_leaderboard (customer_id, total_value, order_id, customer_name, customer_email) 
    VALUES (%s, %s, %s, %s, %s)
    '''
